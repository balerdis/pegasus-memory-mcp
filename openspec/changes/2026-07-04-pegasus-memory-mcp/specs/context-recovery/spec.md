...
Defines read-side behavior for recovering active context, searching local operational memory, listing recent changes/events, surfacing stale signals, and handling ambiguous recovery.
