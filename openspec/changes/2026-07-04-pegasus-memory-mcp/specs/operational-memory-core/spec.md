...
Defines local operational memory writes for projects, changes, sessions, events, artifacts, decisions, handoffs, task progress, freshness metadata, and optional manifest import/export.
